...
import Instructor from '../../../assets/Images/axiora_instructor.png'
      ...
      <div className='flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center'>
        ...
        <div className='lg:w-[50%] flex flex-col'>
          ...
          <p className='font-medium text-[16px] w-[80%] text-richblack-300 mb-12'>
            Instructors from around the world teach millions of students on Axiora. We provide the tools and skills to teach what you love.
          </p>
