  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      if (categories.length > 0) {
        ...
        toast.error("No categories found. Restart the backend to seed defaults, or add categories as Admin.")
      }
      setLoading(false)
    }
      ...
      <div className="flex flex-col space-y-2 ">
        ...
        {!loading && courseCategories.length === 0 && (
          <span className="ml-2 text-xs tracking-wide text-yellow-100">
            No categories in database. Restart the backend server once to create default categories.
          </span>
        )}
